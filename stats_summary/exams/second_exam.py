content = """
\033[1mQuestão 1. Qual a diferença entre estatística paramétrica e não paramétrica?\033[0m
A estatística paramétrica busca estimar parâmetros populacionais, como a média e a variância. Além
...
probabilidade de do vetor de médias serem iguais e 97,1% de probabilidade de serem diferentes". A
conclusão do pesquisador está correta?
...
resposta?\033[0m
Sim, eles são mais poderosos, pois fazem mais suposições. Os testes não paramétricos são mais flexíveis
...
de motoristas em uma rota específica.\033[0m
Amostra: 3 8 21 6 10 0.5 45 1 9 25 3 8 2 7 25 4
...
regularmente. Um grupo dedicou horas extras à prática

, enquanto o outro grupo utilizou técnicas de relaxamento, como meditação ou exercícios de respiração, antes de jogar. Após um período de tempo definido,
os participantes foram avaliados quanto ao seu desempenho em uma série de jogos. Considerando que as
duas variáveis possuem distribuição aproximadamente simétrica, avalie se há diferença entre os métodos,
utilize um α = 0,02.\033[0m
...
de recomendação de amigos em uma plataforma. O objetivo é determinar se o novo algoritmo aumenta
...
Usuários MelodiaFlow 66 62 52 63 62 70 52

 20 40 30
Usuários BeatMaster 72 80 63 65 80 80 80 40 30 25
1) as duas amostras vêm da mesma população vs a mediana do MelodiaFlow é inferior a mediana do
BeatMaster
2) Teste não paramétrico para comparação de duas populações independentes Wilcoxon, teste de
Mann-Whitney ou teste U de Mann-Whitney
3) α = 0, 03
